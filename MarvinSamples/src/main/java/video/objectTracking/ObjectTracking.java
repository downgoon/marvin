		...
		try {
			while (true) {
				...
				if (regionSelected) {
					...
					imageOut.drawRect((Integer) attributesOut.get("regionPx"), (Integer) attributesOut.get("regionPy"),
							(Integer) attributesOut.get("regionWidth"), (Integer) attributesOut.get("regionHeight"),
							Color.red);
				}
